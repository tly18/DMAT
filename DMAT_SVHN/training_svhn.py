...
if __name__ == '__main__':
    ...
    pth_save_dir = os.path.join('./para/double_resnet/line/pgd_AT_double_resnet18_cifar10/lr_3_5e_3/2/')
    ...
    for _epoch in range(epoch):       #  (120,epoch,1)   epoch
        ...
        for batch_num, (data, target) in enumerate(train_loader):
            ...
            data_adv = generation_adv(model_1,model_2,data,target,step_size=0.007,epsilon=0.031,perturb_steps=10,distance='l_inf')
            ...
            if _epoch == 0 and batch_num == 0:
                ...
                result2txt = "line loss = beta * (loss_adv_1 + 0.5 * loss_nat_1) + (1-beta) * (loss_adv_2 + 0.5 * loss_nat_2) + 0.5 * (cosine_similarity(output_adv_1_c, output_adv_2_c) + cosine_similarity(output_nat_1_c, output_nat_2_c)) "
