...
from res_SVHN_2 import ResNet18
...
if __name__ == '__main__':
    ...
    #     root='./dataset/SVHN', split='train', download=False, transform=transform_train)
    # train_loader = torch.utils.data.DataLoader(
    #     trainset, batch_size=train_batch_size, shuffle=True)

    testset = torchvision.datasets.SVHN(
        root='./dataset/SVHN', split='test', download=False, transform=transform_test)
    ...
    #cri
    model_1.load_state_dict(torch.load('./para/double_resnet/cri/pgd_AT_double_resnet18_cifar10/lr_3_5e_3/2/model_1_79_standard_pgd_AT_cifar10.pt', map_location=device))
    model_2.load_state_dict(torch.load('./para/double_resnet/cri/pgd_AT_double_resnet18_cifar10/lr_3_5e_3/2/model_2_79_standard_pgd_AT_cifar10.pt', map_location=device))
    ...
    print('svhn','79')
    beta = torch.nn.Parameter(torch.tensor([0.6522073745727539]).to(device), requires_grad=True)      # 79
    # print('mnist','94')
